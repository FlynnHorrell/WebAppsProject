define(function(){
	...
	// draw the strings
	var str1 = draw.line(0, 4, 533, 4).stroke({color: '#808080', width: 2 });
	var str2 = draw.line(0, 22, 533, 22).stroke({ color: '#808080', width: 2 });
	var str3 = draw.line(0, 42, 533, 42).stroke({ color: '#808080', width: 2 });
	var str4 = draw.line(0, 62, 533, 62).stroke({ color: '#a0a0a0', width: 2 });
	var str5 = draw.line(0, 82, 533, 82).stroke({ color: '#a0a0a0', width: 2 });
	var str6 = draw.line(0, 100, 533, 100).stroke({ color: '#c0c0c0', width: 2 });
